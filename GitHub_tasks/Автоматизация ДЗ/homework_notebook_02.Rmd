...
table <- cleaned_data %>%
  group_by(`Категория продуктов`) %>%
   summarise(`Absolute frequency` = n(),
             `Relative frequency, %` = (n() / nrow(test_1))*100) %>%
...
g1 <- ggplot(cleaned_data) +
  geom_boxplot(aes(x = `Категория продуктов`, y =`Содержание альфа-каротина,мкг`), outliers = FALSE) +
  ylab(label = 'Cодержание альфа-каротина') +
  theme_bw() +
  theme(axis.title.x = element_blank()) +
   scale_color_brewer(palette = "RdYlGn")

g2 <- ggplot(cleaned_data) +
  geom_boxplot(aes(x = `Категория продуктов`,
                   y =`Содержание бетта-каротина,мкг`), outliers = FALSE) +
  ylab(label = 'Cодержание бетта-каротина') +
  theme_bw() +
  theme(axis.title.x = element_blank())

g3 <- ggplot(cleaned_data) +
  geom_boxplot(aes(x = `Категория продуктов`, y =`Содержание бетта-криптоксантина,мкг`), outliers = FALSE) +
  ylab(label = 'Cодержание бетта-криптоксантина') +
  theme_bw() +
  theme(axis.title.x = element_blank())

g4 <- ggplot(cleaned_data) +
  geom_boxplot(aes(x = `Категория продуктов`, y =`Содержание углеводов, г`), outliers = FALSE) +
  ylab(label = 'Cодержание углеводов') +
  theme_bw() +
  theme(axis.title.x = element_blank())

g5 <- ggplot(cleaned_data) +
  geom_boxplot(aes(x = `Категория продуктов`, y =`Уровень холестерина, мг`), outliers = FALSE) +
  ylab(label = 'Cодержание холестерина') +
  theme_bw() +
  theme(axis.title.x = element_blank())

g6 <- ggplot(cleaned_data) +
  geom_boxplot(aes(x = `Категория продуктов`, y = `Содержание холина,мг`), outliers = FALSE) +
  ylab(label = 'Cодержание холина') +
  theme_bw() +
  theme(axis.title.x = element_blank())

g7 <- ggplot(cleaned_data) +
  geom_boxplot(aes(x = `Категория продуктов`, y = `Содержание клетчатки,г`), outliers = FALSE) +
  ylab(label = 'Cодержание клетчатки') +
  theme_bw()+
  theme(axis.title.x = element_blank())

g8 <- ggplot(cleaned_data) +
  geom_boxplot(aes(x = `Категория продуктов`, y = `Содержание неацина,мг`), outliers = FALSE) +
  ylab(label = 'Cодержание неацина') +
  theme_bw() +
  theme(axis.title.x = element_blank())

g9 <- ggplot(cleaned_data) +
  geom_boxplot(aes(x = `Категория продуктов`, y = `Содержание белка,г`), outliers = FALSE) +
  ylab(label = 'Cодержание белка') +
  theme_bw() +
  theme(axis.title.x = element_blank())

g10 <- ggplot(cleaned_data) +
  geom_boxplot(aes(x = `Категория продуктов`, y = `Содержание рибофлавина,мг`), outliers = FALSE) +
  ylab(label = 'Cодержание рибофлавина') +
  theme_bw() +
  theme(axis.title.x = element_blank())

g11 <- ggplot(cleaned_data) +
  geom_boxplot(aes(x = `Категория продуктов`, y = `Содержание селена,мкг`), outliers = FALSE) +
  ylab(label = 'Cодержание селена') +
  theme_bw() +
  theme(axis.title.x = element_blank())

g12 <- ggplot(cleaned_data) +
  geom_boxplot(aes(x = `Категория продуктов`, y = `Общее количество сахара,Г`), outliers = FALSE) +
  ylab(label = 'Cодержание сахара') +
  theme_bw() +
  theme(axis.title.x = element_blank())

g13 <- ggplot(cleaned_data) +
  geom_boxplot(aes(x = `Категория продуктов`, y = `Содержание тиамина,мг`), outliers = FALSE) +
  ylab(label = 'Cодержание тиамина') +
  theme_bw() +
  theme(axis.title.x = element_blank())

g14 <- ggplot(cleaned_data) +
  geom_boxplot(aes(x = `Категория продуктов`, y = `Содержание воды,г`), outliers = FALSE) +
  ylab(label = 'Cодержание воды') +
  theme_bw() +
  theme(axis.title.x = element_blank())

g15 <- ggplot(cleaned_data) +
  geom_boxplot(aes(x = `Категория продуктов`, y = `Мононасыщенные жиры,г`), outliers = FALSE) +
  ylab(label = 'Cодержание мононасыщенных жиров') +
  theme_bw() +
  theme(axis.title.x = element_blank())

g16 <- ggplot(cleaned_data) +
  geom_boxplot(aes(x = `Категория продуктов`, y = `Полинасыщенные жиры,г`), outliers = FALSE) +
  ylab(label = 'Cодержание полинасыщенных жиров') +
  theme_bw() +
  theme(axis.title.x = element_blank())

g17 <- ggplot(cleaned_data) +
  geom_boxplot(aes(x = `Категория продуктов`, y = `Насыщенные жиры,г`), outliers = FALSE) +
  ylab(label = 'Cодержание насыщенных жиров') +
  theme_bw() +
  theme(axis.title.x = element_blank())

g18 <- ggplot(cleaned_data) +
  geom_boxplot(aes(x = `Категория продуктов`, y = `Общее содержание липидов,г`), outliers = FALSE) +
  ylab(label = 'Cодержание жиров общее') +
  theme_bw() +
  theme(axis.title.x = element_blank())

g19 <- ggplot(cleaned_data) +
  geom_boxplot(aes(x = `Категория продуктов`, y = `Содержание кальция,мг`), outliers = FALSE) +
  ylab(label = 'Cодержание кальция') +
  theme_bw() +
  theme(axis.title.x = element_blank())

g20 <- ggplot(cleaned_data) +
  geom_boxplot(aes(x = `Категория продуктов`, y = `Содержание меди,мг`), outliers = FALSE) +
  ylab(label = 'Cодержание меди') +
  theme_bw() +
  theme(axis.title.x = element_blank())

g21 <- ggplot(cleaned_data) +
  geom_boxplot(aes(x = `Категория продуктов`, y = `Содержание железа,мг`), outliers = FALSE) +
  ylab(label = 'Cодержание железа') +
  theme_bw() +
  theme(axis.title.x = element_blank())

g22 <- ggplot(cleaned_data) +
  geom_boxplot(aes(x = `Категория продуктов`, y = `Содержание магния,мг`), outliers = FALSE) +
  ylab(label = 'Cодержание магния') +
  theme_bw() +
  theme(axis.title.x = element_blank())

g23 <- ggplot(cleaned_data) +
  geom_boxplot(aes(x = `Категория продуктов`, y = `Содержание фосфора,мг`), outliers = FALSE) +
  ylab(label = 'Cодержание фосфора') +
  theme_bw() +
  theme(axis.title.x = element_blank())

g24 <- ggplot(cleaned_data) +
  geom_boxplot(aes(x = `Категория продуктов`, y = `Содержания калия,мг`), outliers = FALSE) +
  ylab(label = 'Cодержание калия') +
  theme_bw() +
  theme(axis.title.x = element_blank())

g25 <- ggplot(cleaned_data) +
  geom_boxplot(aes(x = `Категория продуктов`, y = `Содержание натрия,мг`), outliers = FALSE) +
  ylab(label = 'Cодержание натрия') +
  theme_bw() +
  theme(axis.title.x = element_blank())

g26 <- ggplot(cleaned_data) +
  geom_boxplot(aes(x = `Категория продуктов`, y = `Содержание цинка,мг`), outliers = FALSE) +
  ylab(label = 'Cодержание цинка') +
  theme_bw() +
  theme(axis.title.x = element_blank())

g27 <- ggplot(cleaned_data) +
  geom_boxplot(aes(x = `Категория продуктов`, y = `Содержание витамина А,мкг`), outliers = FALSE) +
  ylab(label = 'Cодержание витамина А') +
  theme_bw() +
  theme(axis.title.x = element_blank())

g28 <- ggplot(cleaned_data) +
  geom_boxplot(aes(x = `Категория продуктов`, y = `Содержание витамина В6,мкг `), outliers = FALSE) +
  ylab(label = 'Cодержание витамина В6') +
  theme_bw() +
  theme(axis.title.x = element_blank())

g29 <- ggplot(cleaned_data) +
  geom_boxplot(aes(x = `Категория продуктов`, y = `Содержание витамина Е,мкг`), outliers = FALSE) +
  ylab(label = 'Cодержание витамина Е') +
  theme_bw() +
  theme(axis.title.x = element_blank())

g30 <- ggplot(cleaned_data) +
  geom_boxplot(aes(x = `Категория продуктов`, y = `Содержание витамина К,мкг`), outliers = FALSE) +
...
ggplot(data_food_filtred) +
  geom_boxplot(aes(x = `Категория продуктов`, y = `Содержание витамина В6,мкг `), outliers = FALSE) +
  ylab(label = 'Cодержание витамина В6') +
  ggbeeswarm::geom_beeswarm(aes(x = `Категория продуктов`, y = `Содержание витамина В6,мкг `)) +
  theme_bw() +
  theme(axis.title.x = element_blank())
```
...
```{r}
ggplot(cleaned_data) +
  geom_boxplot(aes(x = `Категория продуктов`, y =`Содержание углеводов, г`)) +
  ylab(label = 'Cодержание углеводов') +
  theme_bw() +
  theme(axis.title.x = element_blank())
```
...
В данном случае все перменные распеределены отлично от нормального. 
...
ggplot(cleaned_data, aes(sample = `Содержание альфа-каротина,мкг`)) +
  stat_qq() +
  stat_qq_line() +
  labs(title = 'Содержание альфа-каротина') +
  theme_bw()

qqnorm(data_food_filtred$`Содержание альфа-каротина,мкг`)
qqline(data_food_filtred$`Содержание альфа-каротина,мкг`) 
labs(title = 'Содержание альфа-каротина') 
```
...
lm(data_food_filtred$`Содержание углеводов, г` ~ ., model_data) %>%
